                        ...
                        <div className={styles.read_warp}>
                            <Space>
                                <Typography.Text className={styles.msg_text}>
                                    一共{msgNum.task_msg_total_num}条通知，其中
                                    {msgNum.task_msg_unread_num}条未读
                                </Typography.Text>
                                <Typography.Text className={styles.msg_read}>
                                    <Button
                                        type="link"
                                        onClick={handleAllRead}
                                        disabled={msgNum.task_msg_unread_num === 0}
                                    >
                                        全部已读
                                    </Button>
                                </Typography.Text>
                                <Typography.Text className={styles.msg_unread}>
                                    <Button
                                        type="link"
                                ...
                                if (item.msg_type === 'job_complete') {
                                    return (
                                        <div className={styles.msg_record} key={item.id}>
                                            ...
                                            >
                                                <Typography.Text>
                                                    <span className={styles.msg_title}>
                                                        [Job] 测试完成
                                                    </span>
                                                    <span
                                                        className={styles.msg_detail}
                                        ...
                                        >
                                            ...
                                            >
                                                <Typography.Text>
                                                    ...
                                                    <span className={styles.msg_default}>
                                                        上的任务在测试准备阶段失败, 机器可能已经
                                                    </span>
                                                    <span
                                                        className={styles.msg_detail}
                                                        style={{ color: '#E53333' }}
                                                    ...
                                                    <span className={styles.msg_detail}>
                                                        {obj.impact_job}
                                                    </span>
                                                    <span className={styles.msg_default}>
                                                        影响的Suite有:
