 ...
 */
export default forwardRef(({ business_id, rowSelectionCallback = () => { }, restId }: any, ref: any) => {
				...
				expandable={{
					expandedRowRender: (record: any) => {
						...
						if (test_type === 'functional' || test_type === 'performance') {
							// 功能测试、性能测试的conf列表
							return <CaseTable id={record.id} type={test_type} ref={caseTable} />
