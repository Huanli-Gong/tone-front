...
import { Popover, Drawer, Button, Form, Row, Col, Input, Select, InputNumber, Space, Radio, message, Popconfirm } from 'antd'
...
export default forwardRef(
    ({ onOk, selectedRowKeys }: any, ref: any) => {
                                                ...
                                                <div>
                                                    {fields.map((field: any, index: any) => (
                                                        <Space key={field.key} style={{ display: 'flex', marginBottom: 8 }} align="start">
                                                            ...
                                                            >
                                                                <Input autoComplete="off" placeholder={formatMessage({ id: 'TestSuite.variable.name' })} allowClear />
                                                            </Form.Item>
                                                            ...
                                                            // }]}
                                                            >
                                                                <Input autoComplete="off" placeholder={formatMessage({ id: 'TestSuite.default' })} allowClear />
                                                            </Form.Item>
                                                            ...
                                                            >
                                                                <Input autoComplete="off" placeholder={formatMessage({ id: 'TestSuite.var.desc' })} allowClear />
                                                            </Form.Item>
