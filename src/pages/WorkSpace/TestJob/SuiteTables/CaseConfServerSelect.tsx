import { Select, Badge, Typography, Form, Input, Tag, Space } from 'antd';
import React from 'react';
import {
    standloneServerList,
    queryClusterServer,
    queryClusterStandaloneServer,
} from '../components/SelectSuite/service';
...
const CaseConfServerSelect: React.FC<any> = (props) => {
    ...
    const serverObjectType = Form.useWatch('server_select_type', form);
    ...
    const switchServerMessage = React.useMemo(() => {
...
export default CaseConfServerSelect;
