...
const text = {
    ...
    'template.message':
        'The value can contain a maximum of 64 characters, including letters, digits, underscores (_), hyphens (-), and dots (.)',
    ...
    //
    'reset.confirm.info':
        'All configurations will be cleared after the reset.Are you sure to reset?',
    reset: 'Reset',
