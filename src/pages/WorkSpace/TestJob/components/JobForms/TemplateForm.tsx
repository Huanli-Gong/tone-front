...
export default forwardRef(({ disabled, template, onEnabelChange }: any, ref: any) => {
    ...
    return (
        ...
        >
            ...
            <Form.Item label={<FormattedMessage id="ws.test.job.description" />} name="description">
                <Input.TextArea
                    rows={2}
                    disabled={disabled}
                    autoComplete="off"
            ...
            <Form.Item label={<FormattedMessage id="ws.test.job.enable" />} name="enable">
                <Radio.Group
                    disabled={disabled}
                    onChange={({ target }) => checkTemplate(target.value)}
                >
                    <Radio value={true}>
