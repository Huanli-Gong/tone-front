...
const text = {
    ...
    // Suite Select Drawer
    'vertical.message':
        'If multiple values are displayed, enter a new value to cover all values. If no value is entered, the original value is retained',
    ...
    'priority.desc':
        'The execution priority ranges from 1 to 20. A larger value indicates a higher priority',
    ...
    'table.is_delete.alart':
        'The selected example does not exist or there are no failed cases in the rerun job.',
};
