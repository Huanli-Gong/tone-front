import {
    aligroupServer_baseline,
    aliyunServer_baseline,
    GROUP_MANAGE,
    CLOUD_MANAGE,
} from '@/utils/utils';

import { localesZhCN as suiteShowTypeFieldsSet } from '@/pages/WorkSpace/JobTypeManage/CreateJobType/components/FieldsSet';
