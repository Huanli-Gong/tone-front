export default {
  ...
  // AddScript
  'baseline.addScript.add': '新增基线信息',
  'baseline.addScript.edit': '编辑基线信息',
  ...
  'pages.workspace.baseline.expandPerf.server_sm_name': '机型',
  'pages.workspace.baseline.expandPerf.run_mode': 'RunMode',
  'pages.workspace.baseline.expandPerf.source_job_id': '来源Job',
  'pages.workspace.baseline.expandPerf.server_instance_type': '规格',
