...
const SummaryTable = (props: any) => {
    const { groupData, baseIndex, setScrollWidth, result } = props
                ...
                render: (row: any, index: number) => {
                    return (
                        <div className="right_border" key={index}>
                            ...
                            {
                                result.perf_data && JSON.stringify(result.perf_data) !== '{}' &&
                                <>
                            ...
                            {
                                result.func_data && JSON.stringify(result.func_data) !== '{}' &&
                                <>
            ...
            columns.push(
                {
                    ...
                    render: (row: any, idx: number) => {
                        return (
                            <div className="right_border" key={idx}>
                                <div className="id_name">
                                    <Tooltip placement="top" title={row?.base_group.tag}>
