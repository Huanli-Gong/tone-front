...
//         (pre: any, cur: any) => pre.concat(cur.key).concat(cur.test_case_list.map((el: any) => el.key)
//         ), [])
// }, [treeData])

// const checkAll = useMemo(() => {
//     return allKeys.length === selectData.length ? true : false
// }, [selectData, treeData, allKeys])



// const selectAll = (e: any) => {
//     e.target.checked ? setSelectData(allKeys) : setSelectData([])
// }
...
{/* <Checkbox
        ...
        //         const elKey : string = index + '-' + sq
        //         el.parentId = item.id
        //         el.key = elKey
        //         el.title = el.name
        //         console.log( selectData.includes( elKey ) , el.id )
        //         if ( !selectData.includes( elKey ) ) {
        //             if ( testType === 'perf_item' ) {
        //                 const clude = perfKeys.includes( el.id )
        //                 if ( clude ) sum ++
        //                 el.disableCheckbox = clude
        //                 el.disabled = clude
        //             }
        //             if ( testType === 'func_item' ) {
        //                 const clude = funcKeys.includes( el.id )
        //                 if ( clude ) sum ++
        //                 el.disableCheckbox = clude
        //                 el.disabled = clude
        //             }
        ...
        //         return el
        //     })
        //     item.checkable = sum !== item.test_case_list.length 
        //     return item
        // })