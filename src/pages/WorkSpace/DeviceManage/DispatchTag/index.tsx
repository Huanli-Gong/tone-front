    ...
    const columns: any[] = [
        {
            ...
            render: (_: string, row: any) => <ResizeTag {...row} />,
        },
        {
            ...
            filterDropdown: ({ confirm }: any) => (
                <SearchInput
                    ...
                    autoFocus={focus}
                    onConfirm={(val: string) =>
                        setListParams((p: any) => ({ ...p, page_num: 1, description: val }))
                    }
                />
            ),
            onFilterDropdownVisibleChange: (visible: any) => {
                        ...
                        <Access accessible={access.WsMemberOperateSelf()}>
                            <Space>
                                ...
                                <Popconfirm
                                    title={
                                        <div style={{ color: 'red' }}>
                                            <FormattedMessage id="device.tag.delete.tips" />
                                        </div>
                                    }
                                    placement="topRight"
            ...
            extra={
                <Access accessible={access.WsMemberOperateSelf()}>
                    <Button key="3" type="primary" onClick={newSuite}>
                        {' '}
                        <FormattedMessage id="device.create.tag" />{' '}
                    </Button>
                </Access>
            }
        >
