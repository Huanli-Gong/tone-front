...
import { Button, Pagination, Space, Popconfirm, Tag, message, Tooltip, Tabs, Modal, Table } from 'antd';
            ...
            },
            {
                ...
                render: (_:any, row:any) =>
                    <Space>
                        ...
                        {
                            String(type) !== '0' && <Button type="link" style={{ padding: 0, height: 'auto' }} onClick={()=>deployClick([row.pub_ip] || [])}>部署</Button>
                        }
                        {String(type) !== '0' && <AuthForm
                            isAuth={['super_admin', 'sys_admin', 'ws_owner', 'ws_admin', 'ws_test_admin']}
                            children={<Button type="link" style={{ padding: 0, height: 'auto' }}>{'删除'}</Button>}
                            onFirm={
                                <Button type="link" style={{ padding: 0, height: 'auto' }} onClick={()=>handleDelServer({ ...row },false)}>{'删除'}</Button>
                            } />
                        }
                        {<AuthForm
                            isAuth={['super_admin', 'sys_admin', 'ws_owner', 'ws_admin', 'ws_test_admin']}
                            children={<Button type="link" style={{ padding: 0, height: 'auto' }}>{type == '0' ? '删除' : '释放'}</Button>}
                            onFirm={
            ...
            <Tabs
                ...
                tabBarExtraContent={
                    <AuthCommon
                        key="add_device"
                        isAuth={['super_admin', 'sys_admin', 'ws_owner', 'ws_admin', 'ws_test_admin']}
                        children={<Button type="primary"> 添加机器 </Button>}
                        onClick={addMachine}
                    />
                }
            >
