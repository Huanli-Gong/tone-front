...
import { Drawer, Space, Form, Input, Button, Row, Badge } from 'antd'
...
// 基础信息
const DrawerForm: any = forwardRef((props, ref) => {
    //
    ...
    const { kernel_info = {}, rpm_info = {}, build_pkg_info = {} }: any = dataSet;
                                ...
                                <SettingRow name={i.name} key={index}>
                                    {
                                        i.template_result.map((t: any) => (
                                            <div key={t.tmpl_name}>{t.tmpl_name}</div>
                                        ))
                                    }
                                </SettingRow>
                            ))
