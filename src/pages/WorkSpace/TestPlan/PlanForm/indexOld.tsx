                                    ...
                                    <RightNav>
                                        <Row justify="space-between" align="middle">
                                            ...
                                            <Space>
                                                ...
                                                <div className={styles.plan_step_btn} onClick={hanleStepNext}>
                                                    {
                                                        current < 2 &&
                                                        <>
...
export default TestPlan
    ...
    // const hanldeSettingFieldsChange = ( values : any ) => {
    //     console.log( values )
    // }

    // const hanldeTiggerFieldsChange = ( values : any ) => {
    //     console.log( values )
    // }

    // const { build_info , kernel_info , test_config , env_perp , cron_schedule , cron_info , blocking_strategy , ...formData } = data
            // setDataSource({
            //     basic : {
            //         ...build_info ,
            //         ...kernel_info,
            ...
            //     },
            //     touch : {
            //         cron_schedule , cron_info , blocking_strategy
            //     }
            // })