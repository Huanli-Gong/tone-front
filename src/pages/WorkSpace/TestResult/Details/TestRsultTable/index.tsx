...
const TestResultTable: React.FC<any> = (props) => {
    ...
    const handleExports = (row: any) => {
        const { suite_name } = row
        window.open(`/api/job/export_results/?job_id=${job_id}&ws_id=${ws_id}&suite_name=${suite_name}`)
    }
                        ...
                        >
                            <Space>
                                ...
                                <span style={btnStyle} onClick={() => handleJoinBaseline(_)}><FormattedMessage id="ws.result.details.join.baseline" /></span>
                                {
                                    ...
                                    <span style={btnStyle} onClick={() => handleExports(_)}><FormattedMessage id="ws.result.details.exports" /></span>
                                }
                            </Space>
                        </Access>
                    </Access>
