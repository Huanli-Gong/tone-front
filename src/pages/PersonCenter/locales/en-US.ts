export default {
  'person.center.approve': 'My Application',
  'person.center.tokenConfig': 'Security Configuration',
  'person.center.introduction': 'introduction',
  'person.center.role': 'Role',
  'person.center.member_count': 'Number',

  'person.center.in_review': 'In Review',
