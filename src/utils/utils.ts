...
export const wsIgnoreScriptInput = BUILD_APP_ENV === "opensource" ? [] : ['k5z7sxfu', 'qorjejwq', 'fgq5x4by', '0zn7ne0u']
export const commonWsIgnoreItems = BUILD_APP_ENV === "opensource" ? [] : ['script', 'cleanup']
